      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="font-display mt-2" style={{ fontSize: "clamp(30px,4.5vw,52px)", lineHeight: 1.04, letterSpacing: "-0.03em" }}>
            What Our Users Are <span className="grad-primary">Saying</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              {/* Quote mark */}
              <div
                className="font-display font-700 text-5xl leading-none mb-4 select-none"
              ...
              <p
                ...
                style={{ color: "hsl(var(--t-secondary))", lineHeight: 1.76 }}
              >
                "{t.quote}"
              </p>
              ...
              <div className="flex items-center gap-3 mt-auto">
                <div>
                  <div
                    className="font-display font-600 text-[13px]"
        ...
        <div className="mt-16 text-center reveal">
          <p
            className="mono text-[11px] mb-6"
            style={{ color: "hsl(var(--t-ghost))", letterSpacing: "0.1em" }}
          >
          ...
          <div className="flex flex-wrap justify-center gap-8 items-center opacity-30">
            {["TECH CO.", "STARTUP INC.", "AGENCY LTD.", "ENTERPRISE CORP.", "STUDIO LLC."].map((name, i) => (
              <span
                ...
                style={{ color: "hsl(var(--t-muted))", letterSpacing: "0.12em" }}
              >
                {name}
              </span>
            ))}
